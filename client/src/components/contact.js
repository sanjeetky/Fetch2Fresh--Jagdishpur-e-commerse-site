                ...
                <div className="row row-content">
                   <div className="col-12">
                    ...
                    <LocalForm onSubmit={(values) => this.handleSubmit(values)}>
                            ...
                            <Row className="form-group">
                                <Col md={{size: 4, offset: 2}} style={{paddingBottom:"10px"}}>
                                    <div className="form-check">
                                        <Label check>
                                            <Control.checkbox model=".agree" style={{paddingBottom:"10px"}} name="agree"
                                                className="form-check-input"
                                                 /> {' '}
                                                <strong style={{marginLeft:"20px"}}>May we contact you?</strong>
                                        </Label>
                                    </div>
                                </Col>
